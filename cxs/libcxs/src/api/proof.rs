...
mod tests {
    ...
    fn test_get_proof_fails_when_not_ready_with_proof() {
        ...
        thread::sleep(Duration::from_millis(300));
        let rc = cxs_get_proof(0, handle, connection_handle, Some(no_proof_cb));
        assert_eq!(rc, error::SUCCESS.code_num);
        thread::sleep(Duration::from_millis(300));
    }
