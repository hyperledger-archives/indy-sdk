...
pub const MESSAGE_CREATED: &'static str = "MS-101";
pub const MESSAGE_SENT: &'static str = "MS-102";
pub const MESSAGE_PENDING: &'static str = "MS-103";
pub const MESSAGE_ACCEPTED: &'static str ="MS-104";
pub const MESSAGE_REJECTED: &'static str ="MS-105";
pub const MESSAGE_ANSWERED: &'static str ="MS-106";
