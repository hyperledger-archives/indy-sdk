...
# random string for multiple wallets
def random_str(N):
...
async def run():
    ...
    logger.warning("Open Pool Ledger: {}".format(pool_['name']))
    ...
    logger.warning("==============================")
    logger.warning("=== Getting Trust Anchor credentials for Faber, Acme, Thrift and Government  ==")
    logger.warning("------------------------------")
    ...
    logger.info("==============================")
    logger.warning("== Getting Trust Anchor credentials - Government Onboarding  ==")
    logger.info("------------------------------")
    ...
    logger.info("==============================")
    logger.warning("== Getting Trust Anchor credentials - Government getting Verinym  ==")
    logger.info("------------------------------")
    ...
    logger.info("==============================")
    logger.warning("== Getting Trust Anchor credentials - Faber Onboarding  ==")
    logger.info("------------------------------")
    ...
    logger.info("==============================")
    logger.warning("== Getting Trust Anchor credentials - Faber getting Verinym  ==")
    logger.info("------------------------------")
    ...
    logger.info("==============================")
    logger.warning("== Getting Trust Anchor credentials - Acme Onboarding  ==")
    logger.info("------------------------------")
    ...
    logger.info("==============================")
    logger.warning("== Getting Trust Anchor credentials - Acme getting Verinym  ==")
    logger.info("------------------------------")
    ...
    logger.info("==============================")
    logger.warning("== Getting Trust Anchor credentials - Thrift Onboarding  ==")
    logger.info("------------------------------")
    ...
    logger.info("==============================")
    logger.warning("== Getting Trust Anchor credentials - Thrift getting Verinym  ==")
    logger.info("------------------------------")
    ...
    logger.info("==============================")
    logger.warning("=== Credential Schemas Setup ==")
    logger.info("------------------------------")
    ...
    logger.info("==============================")
    logger.warning("=== Faber Credential Definition Setup ==")
    logger.info("------------------------------")
    ...
    logger.info("==============================")
    logger.warning("=== Acme Credential Definition Setup ==")
    logger.info("------------------------------")
    ...
    logger.warning("\"Acme\" -> Creates Revocation Registry ({})".format(rev_reg_max_cred_count))
    ...
    (acme['revoc_reg_id'], acme['revoc_reg_def'], acme['revoc_reg_entry']) = \
        await anoncreds.issuer_create_and_store_revoc_reg(acme['wallet'], acme['did'], 'CL_ACCUM', 'TAG1',
                                                          ...
                                                          json.dumps({'max_cred_num': rev_reg_max_cred_count,
                                                                      'issuance_type': 'ISSUANCE_ON_DEMAND'}),
                                                          tails_writer)

    logger.warning("\"Acme\" -> Post Revocation Registry Definition to Ledger")
    ...
    logger.warning("\"Acme\" -> Post Revocation Registry Entry to Ledger")
...
async def run_alice_credential_loop(i, j, unique_str, pool_in, faber_in, acme_in, thrift_in):
    logger.warning("==============================")
    logger.warning("Alice {} of {} (Alice{})".format(i, j, unique_str))
    logger.warning("==============================")

    # copy the input dicts so we don't overwrite each other
    pool_ = pool_in.copy()
    faber = faber_in.copy()
    acme = acme_in.copy()
