...
# libindy 1.8.1-1032 master
# libnullpay 1.8.1-1032 master
# libsovtoken 0.9.6~-.1.126 stable
# libvcx 0.2.38307483-ef2ae4b
...
through to the libvcx shared library.
  ...
  s.source           = { :http => 'https://repo.corp.evernym.com/filely/ios/vcx.libvcxpartial_0.2.38307483-ef2ae4b_universal.zip' }
