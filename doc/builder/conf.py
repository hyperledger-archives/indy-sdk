...
project = u'Hyperledger Indy SDK'
...
htmlhelp_basename = 'HyperledgerIndySDKdoc'
...
latex_documents = [
    (master_doc, 'HyperledgerIndySDK.tex', u'Hyperledger Indy SDK Documentation',
...
man_pages = [
    (master_doc, 'hyperledgerindysdk', u'Hyperledger Indy SDK Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HyperledgerIndySDK', u'Hyperledger Indy SDK Documentation',
     author, 'HyperledgerIndySDK', 'One line description of project.',
     'Miscellaneous'),
]
