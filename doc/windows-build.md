...
Create an empty static library project in Visual Sutio and add `sqlite3.c` file and 2 headers from extracted
...
- If necessary change solution platforms to x64 (if you are working on x64 arch).
