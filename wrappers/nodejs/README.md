...
* `attrNames`: Json - a list of schema attributes descriptions (the number of attributes should be less or equal than 150)
...
```
{
    ...
    name: Schema's name string (the number of attributes should be less or equal than 150)
