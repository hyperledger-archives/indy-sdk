...
public class AnoncredsRevocationInteractionTest extends IndyIntegrationTestWithPoolAndSingleWallet {
    ...
    public void testAnoncredsRevocationInteractionIssuanceByDemand() throws Exception {
        ...
        String schemaReqResp = Ledger.signAndSubmitRequest(pool, wallet, issuerDid,
                schemaRequest).get();

        // Issuer get Schema from Ledger
        String getSchemaData = new JSONObject().put("name", GVT_SCHEMA_NAME).put("version", SCHEMA_VERSION).toString();
        ...
        String schemaId = schemaInfo1.getId();
        ...
        AnoncredsResults.IssuerCreateCredentialResult credRegInfo =
                Anoncreds.issuerCreateCredential(wallet, credOfferJson, credReqJson,
                        gvtCredentialValuesJson, revRegId,
        ...
        /* FIXME */
        String getRevRegDeltaRequest = Ledger.buildGetRevocRegDeltaRequest(proverDid, revRegId, 0, (int) to).get();
        ...
        getSchemaData = new JSONObject().put("name", GVT_SCHEMA_NAME).put("version", SCHEMA_VERSION).toString();
        ...
        String revStatesJson = new JSONObject().put(revRegId, new JSONObject().
                put(new String(timestamp + ""), new JSONObject(revStateJson))).toString();
        ...
        String revRegsJson = new JSONObject().put(revRegId, new JSONObject().
                put(new String(timestamp + ""), new JSONObject(revRegJson))).toString();
