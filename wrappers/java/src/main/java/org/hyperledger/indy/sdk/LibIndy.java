...
//		public int indy_issuer_recover_credential(int command_handle, int wallet_handle, int blob_storage_reader_handle, String rev_reg_id, String cred_revoc_id, Callback cb);
		...
		int indy_build_payment_req(int command_handle, String inputs_json, String outputs_json, Callback cb);
		int indy_parse_payment_response(int command_handle, String payment_method, String resp_json, Callback cb);
		int indy_build_mint_req(int command_handle, String outputs_json, Callback cb);
		int indy_build_set_txn_fees_req(int command_handle, String payment_method, String fees_json, Callback cb);
		int indy_build_get_txn_fees_req(int command_handle, String payment_method, Callback cb);
