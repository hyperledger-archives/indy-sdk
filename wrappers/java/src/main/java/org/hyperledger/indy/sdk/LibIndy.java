...
//		public int indy_issuer_recover_credential(int command_handle, int wallet_handle, int blob_storage_reader_handle, String rev_reg_id, String cred_revoc_id, Callback cb);
		...
		int indy_add_request_fees(int command_handle, String req_json, String inputs_json, String outputs_json, int wallet_handle, Callback cb);
		int indy_parse_response_with_fees(int command_handle, String payment_method, String resp_json, Callback cb);
		int indy_build_get_utxo_request(int command_handle, String payment_method, int wallet_handle, Callback cb);
		int indy_parse_get_utxo_response(int command_handle, String payment_method, String resp_json, Callback cb);
		int indy_build_payment_req(int command_handle, String inputs_json, String outputs_json, int wallet_handle, Callback cb);
		int indy_parse_payment_response(int command_handle, String payment_method, String resp_json, Callback cb);
		int indy_build_mint_req(int command_handle, String outputs_json, int wallet_handle, Callback cb);
		int indy_build_set_txn_fees_req(int command_handle, String payment_method, String fees_json, int wallet_handle, Callback cb);
		int indy_build_get_txn_fees_req(int command_handle, String payment_method, int wallet_handle, Callback cb);
