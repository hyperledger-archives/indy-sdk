...
public abstract class LibIndy {
	...
	public interface API extends Library {
		...
		public int indy_issuer_create_and_store_claim_offer(int command_handle, int wallet_handle, String schema_json, String issuer_did, String prover_did, Callback cb);
