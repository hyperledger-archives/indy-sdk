...
namespace Indy.Sdk.Dotnet.Test.Wrapper.AnonCredsTests
{
    ...
    public class IssuerCreateClaimTest : AnonCredsIntegrationTestBase
    {
        ...
        [TestMethod]
        public async Task TestProverCreateAndStoreClaimReqWorksForClaimDoesNotCorrespondToClaimRequest()
        {
            InitCommonWallet();
        ...
        [TestMethod]
        public async Task TestProverCreateAndStoreClaimReqWorksForInvalidClaim()
        {
            InitCommonWallet();
