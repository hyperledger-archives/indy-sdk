...
/**
 ...
 @param issuerDid a DID of the issuer signing claim_def transaction to the Ledger
...
/**
 ...
 @param walletHandle wallet handler (created by IndyWallet::openWalletWithName).
 @param issuerDid a DID of the issuer signing revoc_reg transaction to the Ledger
...
/**
 ...
 @param walletHandle wallet handler (created by IndyWallet::openWalletWithName).
 @param claimReqJSON a claim request with a blinded secret from the user (returned by IndyAnoncreds::proverCreateAndStoreClaimReqWithWalletHandle).
