...
- (void)testProverGetClaimOffersWorksForFilterBySchema {
    ...
    XCTAssertTrue([[NSDictionary dictionaryWithDictionary:offers[0][@"schema_key"]] isEqualToDictionary:xyzSchemaKeyDict]);
}
...
- (void)testProverGetClaimOffersWorksForFilterByIssuerAndSchema {
    ...
    XCTAssertTrue([[NSString stringWithString:offers[0][@"issuer_did"]] isEqualToString:[TestUtils issuerDid]]);

    NSDictionary *gvtSchemaKeyDict = [NSDictionary fromString:[[AnoncredsUtils sharedInstance] getGvtSchemaKey]];
    XCTAssertTrue([[NSDictionary dictionaryWithDictionary:offers[0][@"schema_key"]] isEqualToDictionary:gvtSchemaKeyDict]);
