...
- (void)testIssuerCreateAndStoreClaimDefWorks
{
    ...
    XCTAssertEqual([[claimDef[@"data"][@"p_key"][@"r"] allKeys] count], 4, @"wrong length:claimDef[data][p_key][r]");
    XCTAssertTrue([claimDef[@"data"][@"p_key"][@"n"] length] > 0, @"wrong length:claimDef[data][p_key][n]");
    XCTAssertTrue([claimDef[@"data"][@"p_key"][@"s"] length] > 0, @"wrong length:claimDef[data][p_key][s]");
    XCTAssertTrue([claimDef[@"data"][@"p_key"][@"rms"] length] > 0, @"wrong length:claimDef[data][p_key][rms]");
    XCTAssertTrue([claimDef[@"data"][@"p_key"][@"z"] length] > 0, @"wrong length:claimDef[data][p_key][z]");
    XCTAssertTrue([claimDef[@"data"][@"p_key"][@"rctxt"] length] > 0, @"wrong length:claimDef[data][p_key][rctxt]");
}
...
- (void)testProverGetClaimOffersWorksForNoResults
{
    ...
    // 2. get claim offers
    NSString *filter = @"{\"schema_seq_no\":4}";
    NSString *claimOffersJson;
    ret = [[AnoncredsUtils sharedInstance] proverGetClaimOffers:walletHandle
                                                     filterJson:filter
                                             outClaimOffersJSON:&claimOffersJson];
...
- (void)testProverCreateProofWorks
{
    ...
    NSDictionary *claims = [NSDictionary fromString:claimsJson];
    NSDictionary *attrUUID = claims[@"attrs"][@"attr1_uuid"][0][@"claim_uuid"];
    NSDictionary *predicateUUID = claims[@"predicates"][@"predicate1_uuid"][0][@"claim_uuid"];
