...
- (void)testProverStoreClaimOfferWorksForInvalidIssuerDid
{
    ...
    NSString *claimOfferJson = [NSString stringWithFormat:@"{\"issuer_did\":\"invalid_base58_string\","\
...
- (void)testProverGetClaimOffersWorksForDifferentWallets
{
    ...
    offer[@"schema_key"] = [[AnoncredsUtils sharedInstance] getXyzSchemaKey];
...
- (void)testProverCreateAndStoreClaimReqWorksForInvalidClaimOffer
{
    ...
    NSString *claimOfferJson = [NSString stringWithFormat:@"{\"schema_key\":%@}", [[AnoncredsUtils sharedInstance] getGvtSchemaKey]];
