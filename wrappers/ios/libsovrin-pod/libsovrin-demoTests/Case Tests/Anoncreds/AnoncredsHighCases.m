...
- (void)testIssuerCreateClaimWorks
{
    ...
    XCTAssertTrue([claim[@"claims_signature"][@"primary_claim"][@"a"] length] > 0, @"wrong \"a\" length");
    XCTAssertTrue([claim[@"claims_signature"][@"primary_claim"][@"m2"] length] > 0, @"wrong \"m2\" length");
    XCTAssertTrue([claim[@"claims_signature"][@"primary_claim"][@"e"] length] > 0, @"wrong \"e\" length");
    XCTAssertTrue([claim[@"claims_signature"][@"primary_claim"][@"v"] length] > 0, @"wrong \"v\" length");
}
