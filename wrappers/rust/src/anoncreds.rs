...
impl Issuer {
    ...
    fn _create_schema(command_handle: IndyHandle, issuer_did: &str, name: &str, version: &str, attrs: &str, cb: indy::indy_str_str_cb) -> ErrorCode {
        ...
        ErrorCode::from(unsafe {
            indy::indy_issuer_create_schema(command_handle, issuer_did.as_ptr(), name.as_ptr(), version.as_ptr(), attrs.as_ptr(), cb)
        })
    }
    ...
    fn _create_and_store_credential_def(command_handle: IndyHandle, wallet_handle: IndyHandle, issuer_did: &str, schema_json: &str, tag: &str, signature_type: Option<&str>, config_json: &str, cb: indy::indy_str_str_cb) -> ErrorCode {
        let issuer_did = c_str!(issuer_did);
        ...
        ErrorCode::from(unsafe {
            indy::indy_issuer_create_and_store_credential_def(command_handle, wallet_handle, issuer_did.as_ptr(), schema_json.as_ptr(), tag.as_ptr(), opt_c_ptr!(signature_type, signature_type_str), config_json.as_ptr(), cb)
        })
    }
    ...
    fn _create_and_store_revoc_reg(command_handle: IndyHandle, wallet_handle: IndyHandle, issuer_did: &str, revoc_def_type: Option<&str>, tag: &str, cred_def_id: &str, config_json: &str, tails_writer_handle: IndyHandle, cb: indy::indy_str_str_str_cb) -> ErrorCode {
        let issuer_did = c_str!(issuer_did);
        ...
        ErrorCode::from(unsafe {
            indy::indy_issuer_create_and_store_revoc_reg(command_handle, wallet_handle, issuer_did.as_ptr(), opt_c_ptr!(revoc_def_type, revoc_def_type_str), tag.as_ptr(), cred_def_id.as_ptr(), config_json.as_ptr(), tails_writer_handle, cb)
        })
    }
    ...
    fn _create_credential_offer(command_handle: IndyHandle, wallet_handle: IndyHandle, cred_def_id: &str, cb: indy::indy_str_cb) -> ErrorCode {
        let cred_def_id = c_str!(cred_def_id);

        ErrorCode::from(unsafe {
            indy::indy_issuer_create_credential_offer(command_handle, wallet_handle, cred_def_id.as_ptr(), cb)
        })
    }
    ...
    fn _create_credential(command_handle: IndyHandle, wallet_handle: IndyHandle, cred_offer_json: &str, cred_req_json: &str, cred_values_json: &str, rev_reg_id: Option<&str>, blob_storage_reader_handle: IndyHandle, cb: indy::indy_str_str_str_cb) -> ErrorCode {
        ...
        ErrorCode::from(unsafe {
            indy::indy_issuer_create_credential(command_handle, wallet_handle, cred_offer_json.as_ptr(), cred_req_json.as_ptr(), cred_values_json.as_ptr(), opt_c_ptr!(rev_reg_id, rev_reg_id_str), blob_storage_reader_handle, cb)
        })
    }
    ...
    fn _revoke_credential(command_handle: IndyHandle, wallet_handle: IndyHandle, blob_storage_reader_cfg_handle: IndyHandle, rev_reg_id: &str, cred_revoc_id: &str, cb: indy::indy_str_cb) -> ErrorCode {
        let rev_reg_id = c_str!(rev_reg_id);
        let cred_revoc_id = c_str!(cred_revoc_id);

        ErrorCode::from(unsafe {
            indy::indy_issuer_revoke_credential(command_handle, wallet_handle, blob_storage_reader_cfg_handle, rev_reg_id.as_ptr(), cred_revoc_id.as_ptr(), cb)
        })
    }
    ...
    fn _merge_revocation_registry_deltas(command_handle: IndyHandle, rev_reg_delta_json: &str, other_rev_reg_delta_json: &str, cb: indy::indy_str_cb) -> ErrorCode {
        let rev_reg_delta_json = c_str!(rev_reg_delta_json);
        let other_rev_reg_delta_json = c_str!(other_rev_reg_delta_json);

        ErrorCode::from(unsafe {
            indy::indy_issuer_merge_revocation_registry_deltas(command_handle, rev_reg_delta_json.as_ptr(), other_rev_reg_delta_json.as_ptr(), cb)
        })
    }
}
...
impl Prover {
    ...
    fn _create_master_secret(command_handle: IndyHandle, wallet_handle: IndyHandle, master_secret_id: Option<&str>, cb: indy::indy_str_cb) -> ErrorCode {
        let master_secret_id_str = opt_c_str!(master_secret_id);

        ErrorCode::from(unsafe {
            indy::indy_prover_create_master_secret(command_handle, wallet_handle, opt_c_ptr!(master_secret_id, master_secret_id_str), cb)
        })
    }
    ...
    fn _get_credential(command_handle: IndyHandle, wallet_handle: IndyHandle, cred_id: &str, cb: indy::indy_str_cb) -> ErrorCode {
        let cred_id = c_str!(cred_id);

        ErrorCode::from(unsafe {
            indy::indy_prover_get_credential(command_handle, wallet_handle, cred_id.as_ptr(), cb)
        })
    }
    ...
    fn _create_credential_req(command_handle: IndyHandle, wallet_handle: IndyHandle, prover_did: &str, cred_offer_json: &str, cred_def_json: &str, master_secret_id: &str, cb: indy::indy_str_str_cb) -> ErrorCode {
        ...
        ErrorCode::from(unsafe {
            indy::indy_prover_create_credential_req(command_handle, wallet_handle, prover_did.as_ptr(), cred_offer_json.as_ptr(), cred_def_json.as_ptr(), master_secret_id.as_ptr(), cb)
        })
    }
    ...
    fn _store_credential(command_handle: IndyHandle, wallet_handle: IndyHandle, cred_id: Option<&str>, cred_req_metadata_json: &str, cred_json: &str, cred_def_json: &str, rev_reg_def_json: Option<&str>, cb: indy::indy_str_cb) -> ErrorCode {
        ...
        ErrorCode::from(unsafe {
            indy::indy_prover_store_credential(command_handle, wallet_handle, opt_c_ptr!(cred_id, cred_id_str), cred_req_metadata_json.as_ptr(), cred_json.as_ptr(), cred_def_json.as_ptr(), opt_c_ptr!(rev_reg_def_json, rev_reg_def_json_str), cb)
        })
    }
    ...
    fn _get_credentials(command_handle: IndyHandle, wallet_handle: IndyHandle, filter_json: Option<&str>, cb: indy::indy_str_cb) -> ErrorCode {
        let filter_json_str = opt_c_str!(filter_json);

        ErrorCode::from(unsafe {
            indy::indy_prover_get_credentials(command_handle, wallet_handle, opt_c_ptr!(filter_json, filter_json_str), cb)
        })
    }
    ...
    fn _search_credentials(command_handle: IndyHandle, wallet_handle: IndyHandle, query_json: Option<&str>, cb: indy::indy_handle_u32_cb) -> ErrorCode {
        let query_json_str = opt_c_str!(query_json);

        ErrorCode::from(unsafe {
            indy::indy_prover_search_credentials(command_handle, wallet_handle, opt_c_ptr!(query_json, query_json_str), cb)
        })
    }
    ...
    fn _fetch_credentials(command_handle: IndyHandle, search_handle: IndyHandle, count: usize, cb: indy::indy_str_cb) -> ErrorCode {
        ErrorCode::from(unsafe {
            indy::indy_prover_fetch_credentials(command_handle, search_handle, count as u32, cb)
        })
    }
    ...
    fn _close_credentials_search(command_handle: IndyHandle, search_handle: IndyHandle, cb: indy::indy_empty_cb) -> ErrorCode {
        ErrorCode::from(unsafe {
            indy::indy_prover_close_credentials_search(command_handle, search_handle, cb)
        })
    }
    ...
    fn _get_credentials_for_proof_req(command_handle: IndyHandle, wallet_handle: IndyHandle, proof_request_json: &str, cb: indy::indy_str_cb) -> ErrorCode {
        let proof_request_json = c_str!(proof_request_json);

        ErrorCode::from(unsafe {
            indy::indy_prover_get_credentials_for_proof_req(command_handle, wallet_handle, proof_request_json.as_ptr(), cb)
        })
    }
    ...
    fn _search_credentials_for_proof_req(command_handle: IndyHandle, wallet_handle: IndyHandle, proof_request_json: &str, extra_query_json: Option<&str>, cb: indy::indy_handle_cb) -> ErrorCode {
        let proof_request_json = c_str!(proof_request_json);
        let extra_query_json_str = opt_c_str!(extra_query_json);

        ErrorCode::from(unsafe {
            indy::indy_prover_search_credentials_for_proof_req(command_handle, wallet_handle, proof_request_json.as_ptr(), opt_c_ptr!(extra_query_json, extra_query_json_str), cb)
        })
    }
    ...
    fn __fetch_credentials_for_proof_req(command_handle: IndyHandle, search_handle: IndyHandle, item_referent: &str, count: usize, cb: indy::indy_str_cb) -> ErrorCode {
        let item_referent = c_str!(item_referent);

        ErrorCode::from(unsafe {
            indy::indy_prover_fetch_credentials_for_proof_req(command_handle, search_handle, item_referent.as_ptr(), count as u32, cb)
        })
    }
    ...
    fn __close_credentials_search_for_proof_req(command_handle: IndyHandle, search_handle: IndyHandle, cb: indy::indy_empty_cb) -> ErrorCode {
        ErrorCode::from(unsafe {
            indy::indy_prover_close_credentials_search_for_proof_req(command_handle, search_handle, cb)
        })
    }
    ...
    fn _create_proof(command_handle: IndyHandle, wallet_handle: IndyHandle, proof_req_json: &str, requested_credentials_json: &str, master_secret_id: &str, schemas_json: &str, credential_defs_json: &str, rev_states_json: &str, cb: indy::indy_str_cb) -> ErrorCode {
        ...
        ErrorCode::from(unsafe {
            indy::indy_prover_create_proof(command_handle, wallet_handle, proof_req_json.as_ptr(), requested_credentials_json.as_ptr(), master_secret_id.as_ptr(), schemas_json.as_ptr(), credential_defs_json.as_ptr(), rev_states_json.as_ptr(), cb)
        })
    }
}
...
impl Verifier {
    ...
    fn _verify_proof(command_handle: IndyHandle, proof_request_json: &str, proof_json: &str, schemas_json: &str, credential_defs_json: &str, rev_reg_defs_json: &str, rev_regs_json: &str, cb: indy::indy_bool_cb) -> ErrorCode {
        let proof_request_json = c_str!(proof_request_json);
        ...
        ErrorCode::from(unsafe {
            indy::indy_verifier_verify_proof(command_handle, proof_request_json.as_ptr(), proof_json.as_ptr(), schemas_json.as_ptr(), credential_defs_json.as_ptr(), rev_reg_defs_json.as_ptr(), rev_regs_json.as_ptr(), cb)
        })
    }
}
...
impl AnonCreds {
    ...
    fn _create_revocation_state(command_handle: IndyHandle, blob_storage_reader_handle: IndyHandle, rev_reg_def_json: &str, rev_reg_delta_json: &str, timestamp: u64, cred_rev_id: &str, cb: indy::indy_str_cb) -> ErrorCode {
        let rev_reg_def_json = c_str!(rev_reg_def_json);
        let rev_reg_delta_json = c_str!(rev_reg_delta_json);
        let cred_rev_id = c_str!(cred_rev_id);

        ErrorCode::from(unsafe {
            indy::indy_create_revocation_state(command_handle, blob_storage_reader_handle, rev_reg_def_json.as_ptr(), rev_reg_delta_json.as_ptr(), timestamp, cred_rev_id.as_ptr(), cb)
        })
    }
    ...
    fn _update_revocation_state(command_handle: IndyHandle, blob_storage_reader_handle: IndyHandle, rev_state_json: &str, rev_reg_def_json: &str, rev_reg_delta_json: &str, timestamp: u64, cred_rev_id: &str, cb: indy::indy_str_cb) -> ErrorCode {
        ...
        ErrorCode::from(unsafe {
            indy::indy_update_revocation_state(command_handle, blob_storage_reader_handle, rev_state_json.as_ptr(), rev_reg_def_json.as_ptr(), rev_reg_delta_json.as_ptr(), timestamp, cred_rev_id.as_ptr(), cb)
        })
    }
}
