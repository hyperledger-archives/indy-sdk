...
*NOTE* that `indy_register_payment_method` API function was updated to accept correspondent callbacks of the new function signatures.
...
*NOTE* that `indy_register_payment_method` API function was updated to accept correspondent callbacks.
