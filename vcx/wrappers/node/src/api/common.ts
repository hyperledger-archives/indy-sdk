export enum VCXCode {
    ...
    INVALID_REVOCATION_DETAILS = 1087,
    INVALID_REV_ENTRY = 1088,
    INVALID_REVOCATION_TIMESTAMP = 1089,
    DUPLICATE_SCHEMA = 1090,
    UNKNOWN_SCHEMA_REJECTION = 1091,
    INVALID_REV_REG_DEF_CREATION = 1092,
    MISSING_PAYMENT_METHOD = 1093,
    UNKNOWN_LIBINDY_REJECTION = 1094
}
