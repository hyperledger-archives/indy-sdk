...
vcx_error_t vcx_wallet_sign_with_payment_address(vcx_command_handle_t chandle, const char *payment_address, const unsigned short *message_raw, vcx_u32_t message_len, void (*cb)(vcx_command_handle_t, vcx_error_t, const unsigned short *, vcx_u32_t))

/** Verify signature with a payment address */
vcx_error_t vcx_wallet_verify_with_payment_address(vcx_command_handle_t chandle, const char *payment_address, const unsigned short *message_raw, vcx_u32_t message_len, const unsigned short *signature_raw, vcx_u32_t signature_len, void (*cb)(vcx_command_handle_t, vcx_error_t, vcx_bool_t))
