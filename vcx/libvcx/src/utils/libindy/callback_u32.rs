...
lazy_static! {
    pub static ref CALLBACKS_U32: Mutex<HashMap<CommandHandle, Box<FnMut(u32) + Send>>> = Default::default();
    pub static ref CALLBACKS_U32_U32: Mutex<HashMap<CommandHandle, Box<FnMut(u32, u32) + Send>>> = Default::default();
    pub static ref CALLBACKS_U32_STR: Mutex<HashMap<CommandHandle, Box<FnMut(u32, Option<String>) + Send>>> = Default::default();
    pub static ref CALLBACKS_U32_U32_STR: Mutex<HashMap<CommandHandle, Box<FnMut(u32, u32, Option<String>) + Send>>> = Default::default();
    pub static ref CALLBACKS_U32_STR_STR: Mutex<HashMap <CommandHandle, Box<FnMut(u32, Option<String>, Option<String>) + Send>>> = Default::default();
    pub static ref CALLBACKS_U32_BOOL: Mutex<HashMap<CommandHandle, Box<FnMut(u32, bool) + Send>>> = Default::default();
    pub static ref CALLBACKS_U32_BIN: Mutex<HashMap<CommandHandle, Box<FnMut(u32, Vec<u8>) + Send>>> = Default::default();
    pub static ref CALLBACKS_U32_OPTSTR_BIN: Mutex<HashMap<CommandHandle,Box<FnMut(u32, Option<String>, Vec<u8>) + Send>>> = Default::default();
    pub static ref CALLBACKS_U32_BIN_BIN: Mutex<HashMap<CommandHandle, Box<FnMut(u32, Vec<u8>, Vec<u8>) + Send>>> = Default::default();
    pub static ref CALLBACKS_U32_U32_STR_STR_STR: Mutex<HashMap<CommandHandle, Box<FnMut(u32, u32, Option<String>, Option<String>, Option<String>) + Send>>> = Default::default();
}
