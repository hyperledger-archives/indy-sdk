...
impl SignedResponse {
    pub fn decode(self, invite_key: &str) -> VcxResult<Response> {
        ...
        let sig_data = &sig_data[8..]; // TODO: FIXME.  proper way to find start
