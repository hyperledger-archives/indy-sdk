...
mod tests {
    ...
    extern "C" fn verify_invalid_proof_cb(handle: u32, err: u32, proof_state: u32, proof_string: *const c_char) {
        ...
        check_useful_c_str!(proof_string, ());
        assert_eq!(proof_string, r#"[{"schema_seq_no":15,"issuer_did":"4fUDR9R7fjwELRvH9JT6HH","credential_uuid":"credential::e5fec91f-d03d-4513-813c-ab6db5715d55","attr_info":{"name":"state","value":"UT","type":"revealed"}}]"#);
