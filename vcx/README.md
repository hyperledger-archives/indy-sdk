...
2) Install libindy_1.6.4 (https://repo.sovrin.org/sdk/deb/pool/xenial/stable/libi/libindy/)
2) Install libnullpay_1.6.4 (https://repo.sovrin.org/sdk/deb/pool/xenial/stable/libn/libnullpay/)
