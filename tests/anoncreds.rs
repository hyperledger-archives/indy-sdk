...
mod high_cases {
    ...
    mod issuer_create_claim {
        ...
        fn issuer_create_claim_works() {
            ...
            let claim_json: Result<ClaimJson, _> = serde_json::from_str(&claim_json);
            assert!(claim_json.is_ok());
        }
    ...
    mod prover_store_claim {
        ...
        fn prover_store_claim_works_for_invalid_claim_json() {
            ...
            let claim_json = r#"{"claim":{"sex":["male","5944657099558967239210949258394887428692050081607692519917050011144233115103"],"age":["28","28"],"name":["Alex","1139481716457488690172217916278103335"],"height":["175","175"]},
                                "claim_def_seq_no":1,"
    ...
    mod prover_get_claims_for_proof_req {
        ...
        #[test]
        fn prover_get_claims_for_proof_req_works_for_does_not_satisfy_predicate() {
            let (wallet_handle, _) = AnoncredsUtils::init_common_wallet();
...
mod medium_cases {
    ...
    mod prover_store_claim {
        ...
        fn prover_store_claim_works_without_claim_req() {
            ...
            let claim_json = r#"{"claim":{"sex":["male","5944657099558967239210949258394887428692050081607692519917050011144233115103"],"age":["28","28"],"name":["Alex","1139481716457488690172217916278103335"],"height":["175","175"]},
                                ...
                                "revoc_reg_seq_no":null,
                                "schema_seq_no":10,
                                "signature":{"primary_claim":{"m2":"52860447312636183767369476481903349046618423276302392993759146262753859184069","a":"","e":"259344723055062059907025491480697571938277889515152306249728583105665800713306759149981690559193987143012367913206299323899696942213235956742930130540706162144403329994959437197877","v_prime":""},"non_revocation_claim":null}}"#;
    ...
    mod prover_get_claims_for_proof_req {
        ...
        #[test]
        fn prover_get_claims_for_proof_req_works_for_revealed_attr_with_other_schema() {
            let (wallet_handle, _) = AnoncredsUtils::init_common_wallet();
