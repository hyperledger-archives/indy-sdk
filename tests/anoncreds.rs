...
mod high_cases {
    ...
    mod prover_get_claims {
        ...
        fn prover_get_claims_works_for_filter_by_issuer_did() {
            ...
            let claims = AnoncredsUtils::prover_get_claims(wallet_handle, r#"{"issuer_did":"NcYxiDXkpYi6ov5FcYDi1e"}"#).unwrap();
            let claims: Vec<ClaimInfo> = serde_json::from_str(&claims).unwrap();
        ...
        fn prover_get_claims_works_for_filter_by_issuer_did_and_schema_seq_no() {
            ...
            let claims = AnoncredsUtils::prover_get_claims(wallet_handle, r#"{"issuer_did":"NcYxiDXkpYi6ov5FcYDi1e", "schema_seq_no":1}"#).unwrap();
            let claims: Vec<ClaimInfo> = serde_json::from_str(&claims).unwrap();
...
mod medium_cases {
    ...
    mod issuer_create_claim {
        ...
        fn issuer_create_claim_works_for_for_invalid_claim_req_json() {
            ...
            let claim_req = r#"{"blinded_ms"{"prover_did":"CnEDk9HrMnmiHXEV1WFgbVCRteYnPqsJwrTdcZaNhFVW"","ur":null},"issuer_did":"NcYxiDXkpYi6ov5FcYDi1e","schema_seq_no":1}"#;
        ...
        fn issuer_create_claim_works_for_for_invalid_claim_json() {
            ...
            let claim_req = r#"{"blinded_ms":{"prover_did":"CnEDk9HrMnmiHXEV1WFgbVCRteYnPqsJwrTdcZaNhFVW","u":"","ur":null},"issuer_did":"NcYxiDXkpYi6ov5FcYDi1e","issuer_did":"NcYxiDXkpYi6ov5FcYDi1e","schema_seq_no":1}"#;
