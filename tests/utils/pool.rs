...
impl PoolUtils {
    ...
    pub fn create_genesis_txn_file(txn_file_name: &str, predefined_data: Option<String>) -> PathBuf {
        ...
        let data = format!("{}\n{}\n{}\n{}\n",
                           ...
                           "{\"data\":{\"alias\":\"Node4\",\"client_ip\":\"127.0.0.1\",\"client_port\":9708,\"node_ip\":\"127.0.0.1\",\"node_port\":9707,\"services\":[\"VALIDATOR\"]},\"dest\":\"4PS3EDQ3dW1tci1Bp6543CfuuebjFrg36kLAUcskGfaA\",\"identifier\":\"TWwCRQRZ2ZHMJFn9TzLp7W\",\"txnId\":\"aa5e817d7cc626170eca175822029339a444eb0ee8f0bd20d3b0b76e566fb008\",\"type\":\"0\"}");
