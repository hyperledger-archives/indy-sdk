...
functions in the SDK can be used to construct rich clients: [Indy-SDK Getting-Started Guide](docs/source/getting-started/getting-started.md)
...
are also available. See the [docs/source/how-tos](docs/source/how-tos) folder.

1. [Write a DID and Query Its Verkey](docs/source/how-tos/write-did-and-query-verkey/README.md)
2. [Rotate a Key](docs/source/how-tos/rotate-key/README.md)
3. [Save a Schema and Cred Def](docs/source/how-tos/save-schema-and-cred-def/README.md)
4. [Issue a Credential](docs/source/how-tos/issue-credential/README.md)
5. [Negotiate a Proof](docs/source/how-tos/negotiate-proof/README.md)
6. [Send a Secure Message](docs/source/how-tos/send-secure-msg/README.md)
...
Please refer to our [release workflow](docs/source/release-workflow.md) for more details.
 ...
 * `libindy.a` - This is a static library, which is compiled with NDK.
 ...
 [How to use instructions.](https://github.com/hyperledger/indy-sdk/blob/master/docs/source/android-build.md#usage)  
...
Pre-built libraries are not provided for MacOS. Please look [here](docs/source/mac-build.md)
...
Pre-built libraries are not provided for RHEL-based distributions. Please look [here](docs/source/rhel-build.md)
...
* [Ubuntu based distributions (Ubuntu 16.04)](docs/source/ubuntu-build.md)
* [RHEL based distributions (Amazon Linux 2017.03)](docs/source/rhel-build.md)
* [Windows](docs/source/windows-build.md)
* [MacOS](docs/source/mac-build.md)
* [Android](docs/source/android-build.md)
...
* [v1.3.0 → v1.4.0](docs/source/migration-guide-1.3.0-1.4.0.md)
* [v1.4.0 → v1.5.0](docs/source/migration-guide-1.4.0-1.5.0.md)
* [v1.5.0 → v1.6.x](docs/source/migration-guide-1.5.0-1.6.0.md)
...
* We use developer certificate of origin (DCO) in all hyperledger repositories,
  ...
  More information can be found in [Signing Commits](docs/source/signing-commits.md) article.
