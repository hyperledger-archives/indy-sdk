...
pub mod build_get_payment_sources_request {
    ...
    pub extern fn handle(cmd_handle: i32, _wallet_handle: i32, submitter_did: *const c_char, payment_address: *const c_char, from: Option<u64>, cb: Option<IndyPaymentCallback>) -> ErrorCode {
        check_useful_opt_c_str!(submitter_did, ErrorCode::CommonInvalidState);
