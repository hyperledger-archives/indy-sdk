...
mkdir /var/repository/repos/libindy/indy-sdk
mkdir /var/repository/repos/libindy/indy-sdk/$version-$number
cd /var/repository/repos/libindy/indy-sdk/$version-$number
put -r ../indy-sdk-dev_"$version"_amd64.deb
put -r ../indy-sdk_"$version"_amd64.deb
ls -l /var/repository/repos/libindy/indy-sdk/$version-$number
EOF
