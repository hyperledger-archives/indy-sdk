...
RUN generate_sovrin_pool_transactions --nodes 4 --clients 5 --nodeNum 1 --ips='10.0.0.100,10.0.0.100,10.0.0.100,10.0.0.100'
RUN generate_sovrin_pool_transactions --nodes 4 --clients 5 --nodeNum 2 --ips='10.0.0.100,10.0.0.100,10.0.0.100,10.0.0.100'
RUN generate_sovrin_pool_transactions --nodes 4 --clients 5 --nodeNum 3 --ips='10.0.0.100,10.0.0.100,10.0.0.100,10.0.0.100'
RUN generate_sovrin_pool_transactions --nodes 4 --clients 5 --nodeNum 4 --ips='10.0.0.100,10.0.0.100,10.0.0.100,10.0.0.100'
