...
mod high_cases {
    ...
    mod key_for_did {
        ...
        fn indy_key_for_did_works_for_get_key_from_ledger() {
            let (trustee_wallet_handle, pool_handle, trustee_did) = utils::setup_trustee();
        ...
        fn indy_key_for_did_works_for_unknown_did() {
            ...
            assert_eq!(ErrorCode::WalletItemNotFound, res.unwrap_err().error_code);
        ...
        fn indy_key_for_did_works_for_invalid_wallet_handle() {
            ...
            assert_eq!(ErrorCode::WalletInvalidHandle, res.unwrap_err().error_code);
    ...
    mod set_endpoint_for_did {
        ...
        fn indy_set_endpoint_for_did_works_for_invalid_did() {
            ...
            assert_eq!(ErrorCode::CommonInvalidStructure, res.unwrap_err().error_code);
    ...
    mod get_endpoint_for_did {
        ...
        fn indy_get_endpoint_for_did_works_for_unknown_did() {
            ...
            assert_eq!(ErrorCode::CommonInvalidState, res.unwrap_err().error_code);
    ...
    mod create_my_did {
        ...
        fn indy_create_my_did_works_for_duplicate() {
            ...
            assert_eq!(res.unwrap_err().error_code, ErrorCode::DidAlreadyExistsError);
    ...
    mod replace_keys_apply {
        ...
        fn indy_replace_keys_apply_works_without_calling_replace_start() {
            ...
            assert_eq!(did::replace_keys_apply(wallet_handle, &my_did).unwrap_err().error_code, ErrorCode::WalletItemNotFound);
        ...
        fn indy_replace_keys_apply_works_for_unknown_did() {
            ...
            assert_eq!(did::replace_keys_apply(wallet_handle, DID).unwrap_err().error_code, ErrorCode::WalletItemNotFound);
        ...
        fn indy_replace_keys_apply_works_for_invalid_wallet_handle() {
            ...
            assert_eq!(did::replace_keys_apply(wallet_handle + 1, DID).unwrap_err().error_code, ErrorCode::WalletInvalidHandle);
    ...
    mod store_their_did {
        ...
        fn indy_store_their_did_works_for_verkey_with_invalid_crypto_type() {
            ...
            let res = did::store_their_did(wallet_handle, &identity_json);
            assert_eq!(ErrorCode::UnknownCryptoTypeError, res.unwrap_err().error_code);
