...
pub const WALLET_CREDENTIALS_ARAGON2I_MOD: &'static str = r#"{"key":"key", "key_derivation_method":"ARGON2I_MOD"}"#;
pub const WALLET_CREDENTIALS_ARAGON2I_INT: &'static str = r#"{"key":"key", "key_derivation_method":"ARGON2I_INT"}"#;
