...
pub const POOL: &'static str = "pool_1";  // FIXME never use global names
...
pub const WALLET_CONFIG: &'static str = r#"{"id":"wallet_1"}"#;  // FIXME never use global names
pub const DEFAULT_WALLET_CONFIG: &'static str = r#"{"id":"wallet_1","storage_type":"default"}"#;  // FIXME never use global names
pub const INMEM_WALLET_CONFIG: &'static str = r#"{"id":"wallet_1","storage_type":"inmem"}"#;  // FIXME never use global names
pub const UNKNOWN_WALLET_CONFIG: &'static str = r#"{"id":"wallet_1","storage_type":"unknown"}"#;  // FIXME never use global names
