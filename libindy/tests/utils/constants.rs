...
pub const WALLET_CREDENTIALS: &'static str = r#"{"key":"key", "key_derivation_method":"ARAGON2I_INT"}"#;
pub const WALLET_CREDENTIALS_ARAGON2I_MOD: &'static str = r#"{"key":"key", "key_derivation_method":"ARAGON2I_MOD"}"#;
pub const WALLET_CREDENTIALS_ARAGON2I_INT: &'static str = r#"{"key":"key", "key_derivation_method":"ARAGON2I_INT"}"#;
