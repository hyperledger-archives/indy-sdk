...
pub const GVT_SCHEMA_ATTRIBUTES: &'static str = r#"["name", "age", "sex", "height", "empty_param"]"#;
pub const GVT_SUB_SCHEMA_ATTRIBUTES: &'static str = r#"["sex", "height_sub", "empty_param"]"#;
