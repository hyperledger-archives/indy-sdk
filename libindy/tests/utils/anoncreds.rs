...
impl AnoncredsUtils {
    ...
    pub fn update_revocation_info(wallet_handle: i32, tails_reader_handle: i32, rev_info_json: &str, rev_reg_def_json: &str,
                                  rev_reg_delta_json: &str, timestamp: u64, user_revoc_index: u32) -> Result<String, ErrorCode> {
        let (receiver, command_handle, cb) = CallbackUtils::_closure_to_cb_ec_string();
    ...
    pub fn credential_def_json() -> &'static str {
        r#"{
            "id":"NcYxiDXkpYi6ov5FcYDi1e:2:NcYxiDXkpYi6ov5FcYDi1e:gvt:1:CL:TAG_1",
    ...
    pub fn proof_json() -> String {
        format!(r#"{{
            ...
            "requested_proof":{{
                "revealed_attrs":{{"attr1_referent":["{}","Alex","1139481716457488690172217916278103335"]}},
                "unrevealed_attrs":{{}},
                "self_attested_attrs":{{}},
                "predicates":{{"predicate1_referent":"{}"}}
            }},
            "identifiers":{{"{}":{{"schema_id":"{}","cred_def_id":"{}"}}}}
        }}"#, SUB_PROOF_ID, SUB_PROOF_ID, SUB_PROOF_ID, SUB_PROOF_ID, AnoncredsUtils::gvt_schema_id(), AnoncredsUtils::issuer_1_gvt_cred_def_id())
    }

    pub fn schemas_for_proof() -> String {
        format!(r#"{{"{}":{}}}"#, SUB_PROOF_ID, AnoncredsUtils::gvt_schema_json())
    }

    pub fn cred_defs_for_proof() -> String {
        format!(r#"{{"{}":{}}}"#, SUB_PROOF_ID, AnoncredsUtils::credential_def_json())
    }
