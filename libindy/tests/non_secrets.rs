...
mod high_cases {
    ...
    mod schema_cache {
        ...
        fn indy_get_schema_empty_options() {
            ...
            let schema_json = non_secrets::get_schema_cache(
                pool_handle,
                wallet_handle,
                DID_MY1,
                schema_id,
        ...
        fn indy_get_schema_empty_options_for_unknown_id() {
            ...
            let res = non_secrets::get_schema_cache(
                pool_handle,
                wallet_handle,
                DID_MY1,
        ...
        fn indy_get_schema_cache_works() {
            ...
            let options_json = json!({}).to_string();
            let schema_json1 = non_secrets::get_schema_cache(
                pool_handle,
                wallet_handle,
                DID_MY1,
                schema_id,
            ...
            let options_json = json!({"noUpdate": true}).to_string();
            let schema_json2 = non_secrets::get_schema_cache(
                pool_handle,
                wallet_handle,
                DID_MY1,
                schema_id,
        ...
        fn indy_purge_schema_cache_no_options() {
            ...
            non_secrets::purge_schema_cache(wallet_handle, "{}").unwrap();
        ...
        fn indy_purge_schema_cache_all_data() {
            ...
            non_secrets::purge_schema_cache(wallet_handle, &json!({"minFresh": -1}).to_string()).unwrap();
        ...
        fn indy_purge_schema_cache_older_than_1000_seconds() {
            ...
            non_secrets::purge_schema_cache(wallet_handle, &json!({"minFresh": 1000}).to_string()).unwrap();
    ...
    mod cred_def_cache {
        ...
        fn indy_get_cred_def_empty_options() {
            ...
            let cred_def_json = non_secrets::get_cred_def_cache(
                pool_handle,
                wallet_handle,
                DID_MY1,
                cred_def_id,
        ...
        fn indy_get_cred_def_only_cache_no_cached_data() {
            ...
            let res = non_secrets::get_cred_def_cache(
                pool_handle,
                wallet_handle,
                DID_MY1,
                cred_def_id,
        ...
        fn indy_get_cred_def_cache_works() {
            ...
            let options_json = json!({}).to_string();
            let cred_def_json1 = non_secrets::get_cred_def_cache(
                pool_handle,
                wallet_handle,
                DID_MY1,
                cred_def_id,
            ...
            // now retrieve it from cache
            let options_json = json!({"noUpdate": true}).to_string();
            let cred_def_json2 = non_secrets::get_cred_def_cache(
                pool_handle,
                wallet_handle,
                DID_MY1,
                cred_def_id,
        ...
        fn indy_purge_cred_def_cache_no_options() {
            ...
            non_secrets::purge_cred_def_cache(wallet_handle, "{}").unwrap();
        ...
        fn indy_purge_cred_def_cache_all_data() {
            ...
            non_secrets::purge_cred_def_cache(wallet_handle, &json!({"minFresh": -1}).to_string()).unwrap();
        ...
        fn indy_purge_cred_def_cache_older_than_1000_seconds() {
            ...
            non_secrets::purge_cred_def_cache(wallet_handle, &json!({"minFresh": 1000}).to_string()).unwrap();
