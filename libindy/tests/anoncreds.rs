    ...
    mod verifier_verify_proof {
        ...
        fn verifier_verify_proof_works_for_proof_does_not_correspond_to_request() {
            ...
            let other_proof_req_json = r#"{"nonce":"123432421212",
                                            "name":"proof_req_1",
                                            "version":"0.1",
                                            "requested_attrs":{"attr1_referent":{"name":"sex", "restrictions":[{"schema_seq_no":1}]}},
                                            "requested_predicates":{"predicate1_referent":{"attr_name":"age","p_type":">=","value":18}}
                                          }"#;
    ...
    mod prover_get_claims_for_proof_req {
        ...
        fn prover_get_claims_for_proof_req_works_for_revealed_attr_with_other_issuer() {
            ...
            let proof_req = r#"{"nonce":"123432421212",
                                    "name":"proof_req_1",
                                    "version":"0.1",
                                    "requested_attrs":{"attr1_referent":{"name":"name", "restrictions":[{"issuer_did":"Ac23dAXkpYi6ov5FcYDi1e"}]}},
                                    "requested_predicates":{}
                                  }"#;
        ...
        fn prover_get_claims_for_proof_req_works_for_revealed_attr_with_list_issuer_dids() {
            ...
            let proof_req = r#"{"nonce":"123432421212",
                                "name":"proof_req_1",
                                "version":"0.1",
                                "requested_attrs":{"attr1_referent":{"name":"name", "restrictions":[{"issuer_did":"Ac23dAXkpYi6ov5FcYDi1e"}, {"issuer_did":"NcYxiDXkpYi6ov5FcYDi1e"}]}},
                                "requested_predicates":{}
                              }"#;
        ...
        fn prover_get_claims_for_proof_req_works_for_revealed_attr_with_list_schemas_se_no() {
            ...
            let proof_req = r#"{"nonce":"123432421212",
                                "name":"proof_req_1",
                                "version":"0.1",
                                "requested_attrs":{"attr1_referent":{"name":"name", "restrictions":[{"schema_seq_no":1}, {"schema_seq_no":2}]}},
                                "requested_predicates":{}
                              }"#;
        ...
        fn prover_get_claims_for_proof_req_works_for_satisfy_predicate_by_specific_issuer_and_schema() {
            ...
            let proof_req = r#"{"nonce":"123432421212",
                                ...
                                "requested_attrs":{},
                                "requested_predicates":{"predicate1_referent":
                                    {"attr_name":"age","p_type":">=","value":18, "restrictions":[{"schema_seq_no":1, "issuer_did":"NcYxiDXkpYi6ov5FcYDi1e"}]}}
                              }"#;
