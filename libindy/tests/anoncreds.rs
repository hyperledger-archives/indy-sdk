...
mod high_cases {
    ...
    mod prover_get_claim_offers {
        ...
        fn prover_get_claim_offers_for_custom_wallet() {
            ...
            let claim_offer_json = AnoncredsUtils::get_claim_offer(ISSUER_DID, &AnoncredsUtils::gvt_schema_key());
            let claim_offer_json2 = AnoncredsUtils::get_claim_offer(ISSUER_DID, &AnoncredsUtils::xyz_schema_key());
            let claim_offer_json3 = AnoncredsUtils::get_claim_offer(DID, &AnoncredsUtils::gvt_schema_key());
    ...
    mod prover_create_and_store_claim_req {
        ...
        fn prover_create_and_store_claim_req_works() {
            ...
            let claim_req_json = AnoncredsUtils::prover_create_and_store_claim_req(wallet_handle, DID, &claim_offer_json,
                                                                                   &claim_def, None, COMMON_MASTER_SECRET).unwrap();
        ...
        fn prover_create_and_store_claim_req_works_for_invalid_wallet() {
            ...
            let res = AnoncredsUtils::prover_create_and_store_claim_req(invalid_wallet_handle, DID, &claim_offer_json,
                                                                        &claim_def, None, COMMON_MASTER_SECRET);
            assert_eq!(res.unwrap_err(), ErrorCode::WalletInvalidHandle);
        }
    ...
    mod issuer_create_claim {
        ...
        fn issuer_create_claim_works() {
            ...
            let claim_req = AnoncredsUtils::gvt_claim_req();
            let claim_values_json = AnoncredsUtils::gvt_claim_values_json();

            let (_, claim_json) = AnoncredsUtils::issuer_create_claim(wallet_handle, &claim_req, &claim_values_json, None).unwrap();
        ...
        fn issuer_create_claim_works_for_claim_does_not_correspond_to_claim_req() {
            ...
            let res = AnoncredsUtils::issuer_create_claim(wallet_handle, &claim_req, &claim_values_json, None);
            assert_eq!(res.unwrap_err(), ErrorCode::CommonInvalidStructure);
        }
        ...
        fn issuer_create_claim_works_for_for_invalid_wallet_handle() {
            ...
            let invalid_wallet_handle = wallet_handle + 100;
            let res = AnoncredsUtils::issuer_create_claim(invalid_wallet_handle, &claim_req, &claim_values_json, None);
            assert_eq!(res.unwrap_err(), ErrorCode::WalletInvalidHandle);
        }
    }
    ...
    mod prover_store_claim {
        ...
        fn prover_store_claim_works() {
            ...
            let claim_req = AnoncredsUtils::prover_create_and_store_claim_req(prover_wallet_handle, DID, &claim_offer_json,
                                                                              &claim_def_json, None, COMMON_MASTER_SECRET).unwrap();

            let claim_values_json = AnoncredsUtils::gvt_claim_values_json();
            let (_, claim_json) = AnoncredsUtils::issuer_create_claim(wallet_handle, &claim_req, &claim_values_json, None).unwrap();

            AnoncredsUtils::prover_store_claim(prover_wallet_handle, &claim_json).unwrap();
        }
    ...
    mod prover_create_proof_works {
        ...
        fn prover_create_proof_works() {
            ...
            let claims_json = AnoncredsUtils::prover_get_claims_for_proof_req(wallet_handle, AnoncredsUtils::proof_request()).unwrap();
    ...
    mod verifier_verify_proof {
        ...
        fn verifier_verify_proof_works_for_correct_proof() {
            ...
            let valid = AnoncredsUtils::verifier_verify_proof(AnoncredsUtils::proof_request(),
...
mod medium_cases {
    ...
    mod prover_get_claim_offers {
        ...
        fn prover_get_claim_offers_works_for_different_wallets() {
            ...
            let claim_offer_json_1 = AnoncredsUtils::get_claim_offer(ISSUER_DID, &AnoncredsUtils::gvt_schema_key());
            let claim_offer_json_2 = AnoncredsUtils::get_claim_offer(ISSUER_DID, &AnoncredsUtils::xyz_schema_key());
            let claim_offer_json_3 = AnoncredsUtils::get_claim_offer(DID, &AnoncredsUtils::xyz_schema_key());
    ...
    mod verifier_verify_proof {
        ...
        fn verifier_verify_proof_works_for_invalid_proof_json_format() {
            ...
            let res = AnoncredsUtils::verifier_verify_proof(AnoncredsUtils::proof_request(),
                                                            &proof_json,
                                                            &schemas_json,
                                                            &claim_defs_json,
                                                            &revoc_regs_json);
...
mod demos {
    ...
    fn verifier_verify_proof_works_for_proof_does_not_correspond_proof_request() {
        ...
        //1. Create wallet, gets wallet handle
        ...
        // 6. Prover store received Claim
        AnoncredsUtils::prover_store_claim(wallet_handle, &claim_json).unwrap();

        // 7. Prover get Claims for Proof Request
    ...
    fn anoncreds_works_for_multiple_issuer_single_prover() {
        ...
        claim_defs.insert(DID_MY2.to_string(), xyz_claim_def_json.clone());
        ...
        let gvt_claim_values_json = AnoncredsUtils::gvt_claim_values_json();
        let (_, gvt_claim_json) = AnoncredsUtils::issuer_create_claim(issuer_gvt_wallet_handle,
                                                                      &gvt_claim_req,
                                                                      &gvt_claim_values_json, None).unwrap();
        ...
        let xyz_claim_values_json = AnoncredsUtils::xyz_claim_values_json();
        let (_, xyz_claim_json) = AnoncredsUtils::issuer_create_claim(issuer_xyz_wallet_handle,
                                                                      &xyz_claim_req,
                                                                      &xyz_claim_values_json, None).unwrap();
    ...
    fn anoncreds_works_for_single_issuer_multiple_claims_single_prover() {
        ...
        //8. Prover create Claim Request for gvt claim offer
        let gvt_claim_req = AnoncredsUtils::prover_create_and_store_claim_req(prover_wallet_handle,
                                                                              DID_MY1,
                                                                              &gvt_claim_offer_json,
                                                                              &gvt_claim_def_json,
        ...
        //9. Issuer create GVT Claim
        let gvt_claim_values_json = AnoncredsUtils::gvt_claim_values_json();
        let (_, gvt_claim_json) = AnoncredsUtils::issuer_create_claim(issuer_wallet_handle,
                                                                      &gvt_claim_req,
                                                                      &gvt_claim_values_json, None).unwrap();

        //10. Prover store received GVT Claim
        AnoncredsUtils::prover_store_claim(prover_wallet_handle, &gvt_claim_json).unwrap();

        //11. Prover create Claim Request for xyz claim offer
        let xyz_claim_req = AnoncredsUtils::prover_create_and_store_claim_req(prover_wallet_handle,
                                                                              DID_MY1,
                                                                              &xyz_claim_offer_json,
                                                                              &xyz_claim_def_json,
    ...
    fn anoncreds_works_for_revocation_registry() {
        ...
        let rev_reg_json = AnoncredsUtils::indy_issuer_create_and_store_revoc_reg(wallet_handle, &ISSUER_DID, &schema, 5).unwrap();
        ...
        let claim_values_json = AnoncredsUtils::gvt_claim_values_json();
        let (revoc_reg_update_json, claim_json) = AnoncredsUtils::issuer_create_claim(wallet_handle,
                                                                                      &claim_req_json,
                                                                                      &claim_values_json, Some(SEQ_NO)).unwrap();
    ...
    fn anoncreds_works_for_claim_revoked_before_proof_created() {
        ...
        let revoc_reg_update_json = AnoncredsUtils::issuer_revoke_claim(wallet_handle, &ISSUER_DID, &schema, SEQ_NO as u32).unwrap();
    ...
    fn anoncreds_works_for_claim_revoked_after_proof_created() {
        ...
        let claim_def_json = AnoncredsUtils::issuer_create_claim_definition(wallet_handle, &ISSUER_DID, &schema,
                                                                            None, true).unwrap();
        //3. Issuer create revocation registry
        let rev_reg_json = AnoncredsUtils::indy_issuer_create_and_store_revoc_reg(wallet_handle, &ISSUER_DID,
                                                                                  &AnoncredsUtils::gvt_schema_json(), 5).unwrap();
