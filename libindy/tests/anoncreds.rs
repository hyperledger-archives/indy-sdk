...
mod medium_cases {
    ...
    mod issuer_create_and_store_credential_def {
        ...
        fn issuer_create_and_store_credential_def_works_for_duplicate() {
            ...
            let res = anoncreds::issuer_create_credential_definition(wallet_handle,
                                                                     ...
                                                                     Some(SIGNATURE_TYPE),
                                                                     Some(&anoncreds::default_cred_def_config()));
            assert_eq!(res.unwrap_err().error_code, ErrorCode::AnoncredsCredDefAlreadyExistsError);
    ...
    mod prover_create_master_secret {
        ...
        fn prover_create_master_secret_works_for_duplicate_name() {
            ...
            assert_eq!(res.unwrap_err().error_code, ErrorCode::AnoncredsMasterSecretDuplicateNameError);
    ...
    mod prover_get_credentials {
        ...
        fn prover_get_credentials_works_for_invalid_json() {
            ...
            assert_eq!(res.unwrap_err().error_code, ErrorCode::WalletQueryError);
...
mod demos {
    ...
    fn anoncreds_works_for_issuance_by_demand_revocation_strategy_for_full_revocation_registry() {
        ...
        assert_eq!(res.unwrap_err().error_code, ErrorCode::AnoncredsRevocationRegistryFullError);
    ...
    fn anoncreds_works_for_issuance_by_demand_revocation_strategy_for_revoke_not_issued_credential_id() {
        ...
        assert_eq!(res.unwrap_err().error_code, ErrorCode::AnoncredsInvalidUserRevocId);
