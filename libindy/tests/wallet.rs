...
mod high_cases {
    ...
    mod create_wallet {
        ...
        fn indy_create_wallet_works_for_unknown_type() {
            ...
            assert_eq!(res.unwrap_err().error_code, ErrorCode::WalletUnknownTypeError);
...
mod medium_cases {
    ...
    mod create_wallet {
        ...
        fn indy_create_wallet_works_for_duplicate_name() {
            ...
            assert_eq!(res.unwrap_err().error_code, ErrorCode::WalletAlreadyExistsError);
    ...
    mod delete_wallet {
        ...
        fn indy_delete_wallet_works_for_not_created() {
            ...
            let res = wallet::delete_wallet(WALLET_CONFIG, WALLET_CREDENTIALS);
            assert_eq!(res.unwrap_err().error_code, ErrorCode::WalletNotFoundError);
        ...
        fn indy_delete_wallet_works_for_wrong_credentials() {
            ...
            assert_eq!(res.unwrap_err().error_code, ErrorCode::WalletAccessFailed);
    ...
    mod open_wallet {
        ...
        fn indy_open_wallet_works_for_twice() {
            ...
            let wallet_handle = wallet::open_wallet(WALLET_CONFIG, WALLET_CREDENTIALS).unwrap();
            let res = wallet::open_wallet(WALLET_CONFIG, WALLET_CREDENTIALS);
            assert_eq!(res.unwrap_err().error_code, ErrorCode::WalletAlreadyOpenedError);
        ...
        fn indy_open_wallet_works_for_invalid_credentials() {
            ...
            assert_eq!(ErrorCode::WalletAccessFailed, res.unwrap_err().error_code);
    ...
    mod import_wallet {
        ...
        fn indy_import_wallet_works_for_duplicate_name() {
            ...
            let res = wallet::import_wallet(WALLET_CONFIG, WALLET_CREDENTIALS, &config_json);
            assert_eq!(ErrorCode::WalletAlreadyExistsError, res.unwrap_err().error_code);
