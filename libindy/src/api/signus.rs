...
/// Crypto*
#[no_mangle]
pub  extern fn indy_pairwise_exists(command_handle: i32,
                                    wallet_handle: i32,
    ...
    let result = CommandExecutor::instance()
        .send(Command::Signus(SignusCommand::PairwiseExists(
            wallet_handle,
            their_did,
            Box::new(move |result| {
...
/// Crypto*
#[no_mangle]
pub  extern fn indy_pairwise_create(command_handle: i32,
                                    wallet_handle: i32,
                                    their_did: *const c_char,
                                    my_did: *const c_char,
                                    cb: Option<extern fn(xcommand_handle: i32, err: ErrorCode)>) -> ErrorCode {
    ...
    let result = CommandExecutor::instance()
        .send(Command::Signus(SignusCommand::CreatePairwise(
            wallet_handle,
            their_did,
            my_did,
            Box::new(move |result| {
...
pub  extern fn indy_pairwise_get_my_did(command_handle: i32,
    ...
    let result = CommandExecutor::instance()
        .send(Command::Signus(SignusCommand::PairwiseGetMyDid(
            wallet_handle,
            their_did,
            Box::new(move |result| {
...
/// Crypto*
#[no_mangle]
pub  extern fn indy_pairwise_set_metadata(command_handle: i32,
                                          wallet_handle: i32,
                                          their_did: *const c_char,
    ...
    let result = CommandExecutor::instance()
        .send(Command::Signus(SignusCommand::PairwiseSetMetadata(
            wallet_handle,
            metadata,
            their_did,
            Box::new(move |result| {
...
/// Crypto*
#[no_mangle]
pub  extern fn indy_pairwise_get_metadata(command_handle: i32,
                                          wallet_handle: i32,
                                          their_did: *const c_char,
    ...
    let result = CommandExecutor::instance()
        .send(Command::Signus(SignusCommand::PairwiseGetMetadata(
            wallet_handle,
            their_did,
            Box::new(move |result| {
