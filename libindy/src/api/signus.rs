...
pub  extern fn indy_crypto_sign(command_handle: i32,
    ...
    let result = CommandExecutor::instance()
        .send(Command::Signus(SignusCommand::CryptoSign(
            wallet_handle,
            my_vk,
            message_raw,
            Box::new(move |result| {
...
pub  extern fn indy_crypto_verify(command_handle: i32,
    ...
    let result = CommandExecutor::instance()
        .send(Command::Signus(SignusCommand::CryptoVerify(
            their_vk,
            message_raw,
            signature_raw,
            Box::new(move |result| {
...
pub  extern fn indy_crypto_box(command_handle: i32,
    ...
    let result = CommandExecutor::instance()
        .send(Command::Signus(SignusCommand::CryptoBox(
            wallet_handle,
            my_vk,
            their_vk,
            message_raw,
...
pub  extern fn indy_crypto_box_open(command_handle: i32,
    ...
    let result = CommandExecutor::instance()
        .send(Command::Signus(SignusCommand::CryptoBoxOpen(
            wallet_handle,
            my_vk,
            their_vk,
            encrypted_msg_raw,
...
pub  extern fn indy_crypto_box_seal(command_handle: i32,
    ...
    let result = CommandExecutor::instance()
        .send(Command::Signus(SignusCommand::CryptoBoxSeal(
            their_vk,
            message_raw,
            Box::new(move |result| {
...
pub  extern fn indy_crypto_box_seal_open(command_handle: i32,
    ...
    let result = CommandExecutor::instance()
        .send(Command::Signus(SignusCommand::CryptoBoxSealOpen(
            wallet_handle,
            my_vk,
            encrypted_msg_raw,
            Box::new(move |result| {
