...
impl AuthzService {
    pub fn new(crypto_service: Rc<CryptoService>) -> AuthzService { AuthzService { crypto_service } }
...
mod tests {
    ...
    fn get_new_authz_service() -> AuthzService {
        let crypto_service: Rc<CryptoService> = Rc::new(CryptoService::new());
