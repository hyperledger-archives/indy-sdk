...
impl LedgerService {
    ...
    pub fn parse_get_schema_response(&self, get_schema_response: &str) -> Result<(String, String), LedgerError> {
        ...
        let res = (schema.id.clone(), serde_json::to_string(&Schema::SchemaV1(schema))?);
    ...
    pub fn parse_get_cred_def_response(&self, get_cred_def_response: &str) -> Result<(String, String), LedgerError> {
        ...
        let res = (cred_def.id.clone(), serde_json::to_string(&CredentialDefinition::CredentialDefinitionV1(cred_def))?);
    ...
    pub fn parse_get_revoc_reg_def_response(&self, get_revoc_reg_def_response: &str) -> Result<(String, String), LedgerError> {
        ...
        let res = (revoc_reg_def.id.clone(), serde_json::to_string(&RevocationRegistryDefinition::RevocationRegistryDefinitionV1(revoc_reg_def))?);
