...
use domain::ledger::request::{Request, PROTOCOL_VERSION};
...
impl LedgerService {
    ...
    pub fn build_nym_request(&self, identifier: &str, dest: &str, verkey: Option<&str>,
        ...
        let request = LedgerService::build_request(identifier, operation)?;
    ...
    pub fn build_revoc_reg_def_request(&self, identifier: &str, data: &str) -> Result<String, CommonError> {
        ...
        let request = LedgerService::build_request(identifier, rev_reg_def_operation)?;
    ...
    pub fn build_request<T>(identifier: &str, operation: T) -> Result<String, CommonError> where T: serde::Serialize {
        let req_id = time::get_time().sec as u64 * (1e9 as u64) + time::get_time().nsec as u64;

        let protocol_version = PROTOCOL_VERSION.lock()
            .map_err(|err| CommonError::InvalidState(err.to_string()))?;

        let request_json = serde_json::to_string(&Request::new(req_id, identifier, operation, protocol_version.clone()))
            .map_err(|err| CommonError::InvalidState(format!("Cannot serialize request: {:?}", err)))?;
        Ok(request_json)
    }
}
...
mod tests {
    ...
    fn build_nym_request_works_for_only_required_fields() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"dest":"dest","type":"1"},"protocolVersion":2"#;
    ...
    fn build_nym_request_works_for_empty_role() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"dest":"dest","role":null,"type":"1"},"protocolVersion":2"#;
    ...
    fn build_nym_request_works_for_optional_fields() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"alias":"some_alias","dest":"dest","role":null,"type":"1","verkey":"verkey"},"protocolVersion":2"#;
    ...
    fn build_get_nym_request_works() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"type":"105","dest":"dest"},"protocolVersion":2"#;
    ...
    fn build_get_ddo_request_works() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"type":"120","dest":"dest"},"protocolVersion":2"#;
    ...
    fn build_attrib_request_works_for_hash_field() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"type":"100","dest":"dest","hash":"hash"},"protocolVersion":2"#;
    ...
    fn build_get_attrib_request_works_for_raw_value() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"type":"104","dest":"dest","raw":"raw"},"protocolVersion":2"#;
    ...
    fn build_get_attrib_request_works_for_hash_value() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"type":"104","dest":"dest","hash":"hash"},"protocolVersion":2"#;
    ...
    fn build_get_attrib_request_works_for_enc_value() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"type":"104","dest":"dest","enc":"enc"},"protocolVersion":2"#;
    ...
    fn build_schema_request_works_for_correct_data() {
        ...
        let expected_result = r#""operation":{"type":"101","data":{"name":"name","version":"1.0","attr_names":["male"]}},"protocolVersion":2"#;
    ...
    fn build_get_schema_request_works_for_correct_data() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"type":"107","dest":"identifier","data":{"name":"name","version":"1.0"}},"protocolVersion":2"#;
    ...
    fn build_get_cred_def_request_works() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"type":"108","ref":1,"signature_type":"signature_type","origin":"origin"},"protocolVersion":2"#;
    ...
    fn build_node_request_works() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"type":"0","dest":"dest","data":{"node_ip":"ip","node_port":1,"client_ip":"ip","client_port":1,"alias":"some","services":["VALIDATOR"],"blskey":"blskey"}},"protocolVersion":2"#;
    ...
    fn build_get_txn_request_works() {
        ...
        let expected_result = r#""identifier":"identifier","operation":{"type":"3","data":1},"protocolVersion":2"#;
