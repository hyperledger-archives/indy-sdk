...
extern "C" {
    ...
    extern indy_error_t indy_pairwise_exists(indy_handle_t command_handle,
                                             indy_handle_t wallet_handle,
    ...
    extern indy_error_t indy_pairwise_create(indy_handle_t command_handle,
                                             indy_handle_t wallet_handle,
                                             const char *  their_did,
                                             const char *  my_did,
    ...
    extern indy_error_t indy_pairwise_set_metadata(indy_handle_t command_handle,
                                                   indy_handle_t wallet_handle,
                                                   const char *  their_did,
                                                   const char *  metadata,
    ...
    extern indy_error_t indy_pairwise_get_metadata(indy_handle_t command_handle,
                                                   indy_handle_t wallet_handle,
                                                   const char *  their_did
